...
const CORE = ['./', './index.html', './correcteur.html', './correcteur-outil.html', './dictee.html', './dictee-outil.html',
              './saisie-vocale.html', './double-sens.html', './omega-key.html', './recherche.html', './donnees.html', './confidentialite.html', './evolution.html', './site.css', './nav.js', './manifest.json', './icon.svg'];
