...
| `ewt_typos_en_probe.js` (**CI**) | rappel du produit sur 626 fautes RÉELLES en contexte, annotées par UD English-EWT (`Typo=Yes` / `CorrectForm`) | 252 bien corrigées (40,3 %) dont 90 rouges ; 3 rouges faux, imprimés ; 259 muettes parce que la graphie est un vrai mot (flexions -s/-ed, of/off, out/our, were/where…) ; plancher 248 / 88, plafond 3 — 231 / 4 avant les règles de vrai mot |
