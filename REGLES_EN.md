...
| `jfleg_en_probe.js` (local) | rouges confirmés par ≥ 1 des 4 annotateurs | 294 / 306 = 96,1 % (références recollées : « do n't » → don't, sinon aucune contraction n'était jamais confirmée) |
| `ewt_typos_en_probe.js` (**CI**) | rappel du produit sur 626 fautes RÉELLES en contexte, annotées par UD English-EWT (`Typo=Yes` / `CorrectForm`) | 253 bien corrigées (40,4 %) dont 91 rouges ; **1 rouge faux** (convience → convince), imprimé ; 259 muettes parce que la graphie est un vrai mot (flexions -s/-ed, of/off, out/our, were/where…) ; cliquet : plancher 250 / 89, plafond 1 — 231 / 4 avant les règles de vrai mot, 252 / 3 avant les deux raffinements a → an et youre |
