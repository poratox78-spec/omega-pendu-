...
- **Après avoir (test de substitution de Rem) : « j'ai passe » → passé, « ils ont marche » → marché ; « ils ont envie » n'est plus réécrit « on » (FP rouge), participes irréguliers hors -er dans la garde on/ont — 3 moteurs** — Critère structurel : après avoir, une forme nue est un participe sauf déterminant ou idiome (liste close). NOUN_E et la garde déterminant restent après « a » nu seulement (homographe de « à »). UD 14 450 : rouges ont→on 7 → 3 ; avoir + NOUN_E sans accent 0. Mesuré le 14/09/2026 : juge 312 · 249 un clic · 229 bruit orange · 14 cassés ; accents 174 ; FP échelle 1,36 % (34/2 500, inchangé). _(JOURNAL 2026-09-14 (nuit))_
