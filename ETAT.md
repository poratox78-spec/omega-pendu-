...
- **Étapes de spellTokenCore encore absentes de la référence (carte complète au 07/09)** — Les 7 désaccords de palier restants sur le gold sont EXACTEMENT les deux dernières étapes JS non portées : `_slipMot`/élongation → auto (alllez, cocinelle, contorl, fourgonette, fautra) et `_aux` participe après auxiliaire → flag (prais→prêté, étudiré→étudiée ; ceuse→cessé vs cesse au même palier). Plus la découpe « a paré » (aparé) et `atStart` ≡ premier token du texte (1 cas). À porter un par un, garde de palier armée — et la garde doit d'abord comparer aussi le palier « mot inconnu » (③ de la file de Rem). _(JOURNAL 2026-09-07 · dys-core.js l.3070-3080 (_slipMot, _aux))_
