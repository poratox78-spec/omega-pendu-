...
- **dys_pipeline_probe : une correction APPLIQUÉE fausse tombe en MUET** — Vu le 07/09/2026 avec b_slip : trés et aprés AFFIRMÉS (flag) sur des fautes ne sont comptés ni en réparé ni en cassé — ils gonflent MUET (+3). Il manque une colonne « appliqué FAUX » (rouge posé sur une faute, mais le mauvais mot) : c'est elle qui aurait montré le prix de b_slip au premier coup d'œil. Dette d'instrument, pas de moteur. _(JOURNAL 2026-09-07 (fin))_
