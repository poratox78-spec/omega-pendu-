...
- **Le « e » muet du futur croit à des verbes rares (casse réelle du produit)** — Vu le 10/09/2026 quand la référence a reçu l'étape : « revérrons »→revérerons (révérer+ons, gold reverrons) est CASSÉ par le produit (auto), « fautra »→fautera (fauter) appliqué faux. L'étape (PR#505) réinsère le e muet dès que radical+er est un verbe des tables — même un verbe rare. Chantier de MOTEUR (3 moteurs), à mesurer avec le juge aligné ; pistes : seuil de fréquence sur le lemme, ou abstention si la forme sans e est à distance 1 d'une forme fréquente (reverrons). _(JOURNAL 2026-09-10 · dys-core.js l.2950-2956)_
