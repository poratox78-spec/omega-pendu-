...
const HASHED = ['index.html', 'correcteur.html', 'dictee.html', 'saisie-vocale.html', 'double-sens.html', 'omega-key.html',
...
const WHITELIST = new Set(['./', './correcteur', './dictee', './double-sens',
