...
const code = html.slice(start, Math.max(ctEnd, ptEnd)) +
  ';globalThis.__corr=correctText;globalThis.__vig={persVig:persVig,sujFlexNom:sujFlexNom,onOntVig:onOntVig,semiInfVig:semiInfVig,rDetNumber:rDetNumber,jestVig:jestVig};globalThis.__toks=toks;globalThis.__segOn=function(t){_SEG=_segInfo(t);};globalThis.__seedSP=function(t){if(!SP.WORDS)SP.WORDS=new Set();if(!SP.POS)SP.POS={};if(!SP.FREQ)SP.FREQ={};t.split(String.fromCharCode(10)).forEach(function(l){' +
...
const VIG_ORD = [['semiInfVig', 'infinitif après semi-auxiliaire à vérifier'],
  ...
  ['rDetNumber', 'nombre du déterminant à vérifier'], ['jestVig', "j'est/j'ai à vérifier"]];   // ⭐ 12/09/2026 : jumelle orange de j'est/j'ai
