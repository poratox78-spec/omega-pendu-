...
def _check():
    ...
    nofp += ["je les ai vues.", "elle les a mangées.", "il les a prises."]   # ⚠️ 12/09/2026 : FP rouge du lot 2 (genre de « les » rabattu au masculin) — participe déjà pluriel → aucun flag
    nofp += ["Je les ai vues la semaine dernière.", "Il l'a aidée à partir.", "La lettre qu'il a écrite hier est belle.", "Quelle robe as-tu choisie ?", "Elle nous a invités à dîner."]   # ⭐ 12/09/2026 : antécédent avant l'auxiliaire → accord JUSTE, aucun flag
