...
def _check():
    ...
    elide += [("vous sommes contents", "sommes", "êtes"), ("vous somme très contents", "somme", "êtes"), ("ils somme là", "somme", "sont"), ("ils ce sont déroulés hier", "ce", "se"), ("les faits ce sont déroulés hier", "ce", "se")]
