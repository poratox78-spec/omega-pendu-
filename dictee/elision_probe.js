...
const CEILING = Number(process.env.CEILING || 10);   // etat mesure au 2026-07-21 : 10 angles morts (41 avant les primitives d'elision). Ce plafond ne doit que BAISSER.
