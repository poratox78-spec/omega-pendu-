...
- **Red (FP=0)**: **subject-verb agreement**, gender, plural, é/er, leur/leurs, **être↔avoir usage** ("il est faim"→"il a faim", "il a allé"→"il est allé"), **misspelled auxiliary** ("vous ete"→"êtes"), **sentence-start capital**. **Green (vigilance)**: confusables, **run-on** (missing punctuation), and **pure grammatical homophones** (a/à, on/ont, son/sont, mais/mes…) — *meaning-dependent, demoted from red after a scale FP audit (on the UD corpus they would fire on the most frequent correct word)*.
