...
- **Rouge (FP=0)** : homophones grammaticaux, **accord sujet-verbe**, genre, pluriel, **usage être↔avoir** (« il est faim »→« il a faim », « il a allé »→« il est allé »), **auxiliaire mal orthographié** (« vous ete »→« êtes »), **majuscule** de début de phrase. **Vert (vigilance)** : confusables + **run-on** (ponctuation manquante entre deux propositions — le sens en dépend).
