...
- Panneau app « 🔤 Décompose » : route lexicale lit aussi `md/mb` + voisins `OLD20/PLD20` d'OMEGA_LEX4 (parité Lexique 4, mots ≥7 lettres). Le panneau vit dans un **`<script>` séparé** (zéro adjacence avec le correcteur).
