...
> Journal le plus à jour : `dictee/JOURNAL.md`. Audit moteur : `AUDIT_OMEGA.md` (+ `AUDIT_STRUCTUREL.md` = sécu/UI/hygiène code). Config & toggles : `docs/CONFIG_TOGGLES.md`. Design cognition/mémoire : `docs/COGNITION_DESIGN.md`. Historique notes moteur (NEO, muette, M3_d falsifié, cheat) : `notes/MOTEUR_HISTORIQUE.md`. Repères SOTA : `docs/HANGMAN_SOTA.md`. Reprise moteur : `REPRISE_MOTEUR.md`.
>
