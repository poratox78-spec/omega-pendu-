...
<<<<<<< HEAD
> ID : `dbochkbaechbemahapplibbhmfkcldln` · version en ligne : **0.6.0** — **0.6.2 téléversée par Rem le 03/09/2026**, puis **0.6.3 téléversée le 04/09/2026** (revue Google en cours) — **0.6.4 PRÊTE le 11/09/2026, non téléversée** : le « e » muet du futur exige un verbe courant (garde mesurée, 3 moteurs ; `revérrons` n'est plus cassé) **+ les textes d'explication de l'audit du 11/09** (6 corrections : test « mordre » réservé aux verbes, 💡 sur -er/-é, c'est/s'est, cardinal qui commande, circonflexe, mot inconnu sans suggestion — gardés par `dictee/textes_probe.js`) **+ `_AFIX_MIN`** (13 formes nues qui polluent le lexique — mere, age, ame, reparer… — auto vers la sœur accentuée, minuscules seulement ; la fausse orange « Ma mere → Mon » disparaît) **+ deux gardes de `vlike`** (« lui » jamais verbe, du/au/aux déterminants : « lui a apeller »/« du travaille a permises » ne prennent plus « à ») **+ `_APOS_FIX`** (aujourdhui → aujourd'hui, quelquun → quelqu'un, jusqua → jusqu'à… 14 soudures closes) **+ « accord adjectif antéposé »** (les prochaine demande → prochaines : DET pluriel + adjectif antéposé, 0 FP UD) et le nom derrière lui (les jeunes lycéen → lycéens) **+ « nom féminin en -ée »** (la cheminé → cheminée, la vu → vue) **+ le présent après un pronom sujet** (il decide → décide, pas décidé) + grace → grâce **+ « il reculer » → reculait (orange) + « je me suis installe » → installé (orange), « j'ai commence » → commencé, « il est oblige » → obligé (rouge), « j'ai passe » → passé, « ils ont marche » → marché ; « ils ont envie » n'est plus touché**
> ID : `dbochkbaechbemahapplibbhmfkcldln` · version en ligne : **0.6.0** — **0.6.2 téléversée par Rem le 03/09/2026**, puis **0.6.3 téléversée le 04/09/2026** (revue Google en cours) — **0.6.4 PRÊTE le 11/09/2026, non téléversée** : le « e » muet du futur exige un verbe courant (garde mesurée, 3 moteurs ; `revérrons` n'est plus cassé) **+ les textes d'explication de l'audit du 11/09** (6 corrections : test « mordre » réservé aux verbes, 💡 sur -er/-é, c'est/s'est, cardinal qui commande, circonflexe, mot inconnu sans suggestion — gardés par `dictee/textes_probe.js`) **+ `_AFIX_MIN`** (13 formes nues qui polluent le lexique — mere, age, ame, reparer… — auto vers la sœur accentuée, minuscules seulement ; la fausse orange « Ma mere → Mon » disparaît) **+ deux gardes de `vlike`** (« lui » jamais verbe, du/au/aux déterminants : « lui a apeller »/« du travaille a permises » ne prennent plus « à ») **+ `_APOS_FIX`** (aujourdhui → aujourd'hui, quelquun → quelqu'un, jusqua → jusqu'à… 14 soudures closes) **+ « accord adjectif antéposé »** (les prochaine demande → prochaines : DET pluriel + adjectif antéposé, 0 FP UD) et le nom derrière lui (les jeunes lycéen → lycéens) **+ « nom féminin en -ée »** (la cheminé → cheminée, la vu → vue) **+ le présent après un pronom sujet** (il decide → décide, pas décidé) + grace → grâce **+ « il reculer » → reculait (orange) + « je me suis installe » → installé (orange), « j'ai commence » → commencé, « il est oblige » → obligé (rouge) ; **« est ce qui vient », « Qui est là » reçoivent le « ? »**
=======
> ID : `dbochkbaechbemahapplibbhmfkcldln` · version en ligne : **0.6.0** — **0.6.2 téléversée par Rem le 03/09/2026**, puis **0.6.3 téléversée le 04/09/2026** (revue Google en cours) — **0.6.4 PRÊTE le 11/09/2026, non téléversée** : le « e » muet du futur exige un verbe courant (garde mesurée, 3 moteurs ; `revérrons` n'est plus cassé) **+ les textes d'explication de l'audit du 11/09** (6 corrections : test « mordre » réservé aux verbes, 💡 sur -er/-é, c'est/s'est, cardinal qui commande, circonflexe, mot inconnu sans suggestion — gardés par `dictee/textes_probe.js`) **+ `_AFIX_MIN`** (13 formes nues qui polluent le lexique — mere, age, ame, reparer… — auto vers la sœur accentuée, minuscules seulement ; la fausse orange « Ma mere → Mon » disparaît) **+ deux gardes de `vlike`** (« lui » jamais verbe, du/au/aux déterminants : « lui a apeller »/« du travaille a permises » ne prennent plus « à ») **+ `_APOS_FIX`** (aujourdhui → aujourd'hui, quelquun → quelqu'un, jusqua → jusqu'à… 14 soudures closes) **+ « accord adjectif antéposé »** (les prochaine demande → prochaines : DET pluriel + adjectif antéposé, 0 FP UD) et le nom derrière lui (les jeunes lycéen → lycéens) **+ « nom féminin en -ée »** (la cheminé → cheminée, la vu → vue) **+ le présent après un pronom sujet** (il decide → décide, pas décidé) + grace → grâce **+ « il reculer » → reculait (orange) + « je me suis installe » → installé (orange), « j'ai commence » → commencé, « il est oblige » → obligé, **« nous iriez » → irions, « vous mange » → mangez, « le chat mangeons » → mange (rouge, le temps écrit est gardé)**
>>>>>>> 17fcd97 (le SUJET donne la personne et le nombre, la FORME ÉCRITE donne le temps (« nous iriez » → irions, « tu irai » → iras) — nous et vous n'étaient dans AUCUNE règle de personne depuis le premier commit du correcteur, et aucun des 4 instruments ne pouvait le dire : ils mesurent un corpus, pas la couverture)
>
