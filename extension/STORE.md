...
>>>>>>> ed4ccd6 (point d'interrogation : « est-ce QUI » comme « est-ce que », « qu est ce qui » sans apostrophe, « Qui est là » — la MAJUSCULE est le discriminateur (sans elle, précision du banc 91 → 48,6 % : les relatives en tête de fragment) ; banc 91,30 % / 26,75 % (était 91,01 / 25,80), planchers relevés ; marqueur du miroir app↔ext raccourci à un préfixe stable)
>
