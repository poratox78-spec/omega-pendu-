...
var w=T[i],lw=w.toLowerCase();
  ...
  function _plurSousPrep(T,i){
    ...
    if(d<1)return false;
    return !!PREP[deacc(T[d-1].toLowerCase())];}
  function rOn(T,i){
...
function estQuestion(t){
  ...
  var _SEMI_AUX={vais:1,vas:1,va:1,allons:1,allez:1,vont:1,allais:1,allait:1,allions:1,alliez:1,allaient:1,
  ...
  function onOntVig(T,i){
    ...
    if(d>0&&_ON_PREP[deacc(String(T[d-1]).toLowerCase())])return null;
    return 'ont';}
...
function spellUnknown(tok,atStart,T,idx){
  ...
  function _osNumAt(F,k){if(_osElidedSing(F[k]))return 's';if(k>0){var dd=deacc(F[k-1]);if(_osNumPl[dd]||_osPlDet2[dd]||_osPlPhrase[dd])return 'p';if(NUM_DET[dd]!==undefined){var _n=deacc(F[k]);
