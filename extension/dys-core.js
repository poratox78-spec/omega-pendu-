...
(function (global) {
  ...
  function rPpEtre(T,i){var lw=T[i].toLowerCase();if(lw.indexOf("'")>=0)return null;
    var inf=_inf1(T[i]);if(inf===null)return null;var stem=inf.slice(0,-2);
