...
function spellUnknown(tok,atStart,T,idx){
  ...
  function plTaisCarte(T,i){
    ...
    var z=PLURIEL_TAIS.prior;for(k=0;k<f.length;k++){var v=PLURIEL_TAIS.lr[f[k]];if(v!==undefined)z+=v;}
    return 1/(1+Math.exp(-z))>PLURIEL_TAIS.seuil;}
