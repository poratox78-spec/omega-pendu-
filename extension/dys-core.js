...
(function (global) {
  ...
  function rAuxMisspell(T,i){if(T[i].toLowerCase().indexOf("'")>=0)return null;var w=deacc(T[i].toLowerCase());if(w.length<2||!/^[a-zà-ÿœæ]+$/.test(w))return null;if(FULL_AUX[w])return null;
